...
#' Draw a spectrogram and create a numeric thumbprint
#' of a sound wave
#' @param ANGEL - "bird" or "man" (who made the sound)
#' @param COCO - file name (e.g., "actor1")
#' @param ID - 1 to 10 actors, 1 to 10 birds, Eva is 11th man
#'
#' @return - spectrogram, spectrogram jpeg, tibble representing specific sound wave
#' @export
#' @import tuneR seewave reshape2 dplyr purrr
#' @examples - bom_thmb(ANGEL = "man", COCO = "Eva", ID = 11)
...
# bom_thmb(ANGEL = "bird", COCO = "bird1", ID = 1)
# bom_thmb(ANGEL = "bird", COCO = "bird2", ID = 2)
# bom_thmb(ANGEL = "bird", COCO = "bird3", ID = 3)
# bom_thmb(ANGEL = "bird", COCO = "bird4", ID = 4)
# bom_thmb(ANGEL = "bird", COCO = "bird5", ID = 5)
# bom_thmb(ANGEL = "bird", COCO = "bird6", ID = 6)
# bom_thmb(ANGEL = "bird", COCO = "bird7", ID = 7)
# bom_thmb(ANGEL = "bird", COCO = "bird8", ID = 8)
# bom_thmb(ANGEL = "bird", COCO = "bird9", ID = 9)
# bom_thmb(ANGEL = "bird", COCO = "bird10", ID = 10)
# bom_thmb(ANGEL = "bird", COCO = "loon", ID = 11)
